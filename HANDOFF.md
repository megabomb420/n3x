...
| Maps | `/maps`, `/maps/$map` | The live event rotation; a card (or a Stats map row) opens one map's own page: the club's numbers there, its best brawlers, the mode split and the members' recent battles on it. |
