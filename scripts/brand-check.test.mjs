...
// The prompt pins that used to live here ("SKILL.md and AGENTS.md name the
// marker path…", "the sections that own the brand-task prohibition…", "SKILL.md
// tells the pass to self-check…") read .grok/skills/og/SKILL.md, a Grok-sandbox
// document that is not part of this checkout. They asserted prose, not
// behavior, so they are gone rather than skipped; the CLI contract they
// checked is covered by the parseBrandCheckArgs and runCheck tests above.
